...
- vm extensions add features to VMs, the custom script extension can for example be used to run a script on provisioning (e.g. to install further software using chocolatey, apt-get etc)
